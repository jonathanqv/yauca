...
# Setting up extra weights
#.__________________________
obsFlow.loc[obsFlow['weight']>0,'weight'] = obsFlow.loc[obsFlow['weight']>0,'Flows'].values / obsFlow['weight'].max()
# obsFlow.loc[obsFlow['weight']>0,'weight'] = obsFlow.loc[obsFlow['weight']>0,'Flows'].values**-0.001
# obsFlow.loc[obsFlow['Flows']>=500,'weight'] = 1
# obsFlow.loc[obsFlow['Flows']<500,'weight'] = 0.75
...
pst.parameter_data.loc[:,'parchglim'] = parms['PARCHGLIM'].values

# pst.parameter_groups.loc[:,'forcen'] = 'switch_5'
# pst.parameter_groups.loc[:,'dermthd'] = 'minvar'
# pst.parameter_groups.loc[:,'derinc'] = 0.02
